    ...
    getDom: function() {
		...
		if(this.songData.playing === "true"){
			...
			if(this.config.showAlbumArt){
				albumart_html += "<div class='album-art-container'><div class='album-art'><img src='http://salonmaster:9000/music/current/cover.jpg?player=b8:27:eb:6b:17:38?random=" + this.songData.title + this.songData.artist + this.songData.album + "' width='200'></div></div>";
			}
